...
-- Cars
INSERT INTO `cars` (`brand_id`, `model`, `year`, `color`, `price_per_day`, `fuel_type`, `transmission`, `seats`, `category`, `description`, `features`, `mileage`, `status`) VALUES
(1, 'Camry', 2024, 'Pearl White', 65.00, 'petrol', 'automatic', 5, 'midsize', 'The Toyota Camry offers exceptional comfort and reliability for your journey.', 'Bluetooth, Backup Camera, Lane Assist, Apple CarPlay', '32 MPG', 'available'),
...
(5, 'Model 3', 2024, 'Deep Blue', 150.00, 'electric', 'automatic', 5, 'luxury', 'All-electric performance sedan with autopilot.', 'Autopilot, Glass Roof, 15" Touchscreen, OTA Updates', '358 mi Range', 'available'),
