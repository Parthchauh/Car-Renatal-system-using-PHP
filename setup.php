...
if ($userCount > 0) {
    ...
    $seeds = [
        ...
        'Cars (12 vehicles)' => "INSERT INTO `cars` (`brand_id`, `model`, `year`, `color`, `price_per_day`, `fuel_type`, `transmission`, `seats`, `category`, `description`, `features`, `mileage`, `status`) VALUES
            (1, 'Camry', 2024, 'Pearl White', 65.00, 'petrol', 'automatic', 5, 'midsize', 'The Toyota Camry offers exceptional comfort and reliability.', 'Bluetooth, Backup Camera, Lane Assist, Apple CarPlay', '32 MPG', 'available'),
            (1, 'RAV4', 2024, 'Midnight Black', 80.00, 'hybrid', 'automatic', 5, 'suv', 'Adventure-ready SUV with hybrid efficiency.', 'AWD, Sunroof, Heated Seats, Adaptive Cruise Control', '38 MPG', 'available'),
            (2, '3 Series', 2024, 'Alpine White', 120.00, 'petrol', 'automatic', 5, 'luxury', 'The BMW 3 Series delivers the ultimate driving experience.', 'Sport Package, Navigation, Leather Seats, Harman Kardon Sound', '30 MPG', 'available'),
            (2, 'X5', 2024, 'Space Gray', 180.00, 'diesel', 'automatic', 7, 'suv', 'Luxury SUV perfect for family trips.', 'Panoramic Roof, Third Row, Ambient Lighting, Gesture Control', '25 MPG', 'available'),
            (3, 'C-Class', 2024, 'Obsidian Black', 130.00, 'petrol', 'automatic', 5, 'luxury', 'Elegant and powerful Mercedes-Benz sedan.', 'MBUX System, Burmester Sound, Digital Cockpit, Wireless Charging', '29 MPG', 'available'),
            (3, 'GLE', 2024, 'Selenite Gray', 200.00, 'diesel', 'automatic', 7, 'suv', 'Premium SUV with commanding presence.', 'Air Suspension, 360 Camera, MBUX, Massage Seats', '24 MPG', 'available'),
            (4, 'Civic', 2024, 'Rallye Red', 55.00, 'petrol', 'manual', 5, 'compact', 'Sporty and efficient compact sedan.', 'Honda Sensing, Bose Audio, Wireless CarPlay, LED Headlights', '36 MPG', 'available'),
            (5, 'Model 3', 2024, 'Deep Blue', 150.00, 'electric', 'automatic', 5, 'luxury', 'All-electric performance sedan with autopilot.', 'Autopilot, Glass Roof, 15-inch Touchscreen, OTA Updates', '358 mi Range', 'available'),
            (5, 'Model Y', 2024, 'Red Multi-Coat', 170.00, 'electric', 'automatic', 7, 'suv', 'Electric SUV with impressive range and space.', 'Full Self-Driving Capable, Camp Mode, Premium Audio', '330 mi Range', 'available'),
            (6, 'A4', 2024, 'Navarra Blue', 110.00, 'petrol', 'automatic', 5, 'luxury', 'Refined luxury sedan with quattro AWD.', 'Virtual Cockpit, B&O Sound, Matrix LED, quattro AWD', '28 MPG', 'available'),
            (7, 'Mustang', 2024, 'Race Red', 140.00, 'petrol', 'manual', 4, 'sports', 'Iconic American muscle car experience.', 'V8 Engine, Track Mode, Recaro Seats, MagneRide Suspension', '22 MPG', 'available'),
            (8, 'Tucson', 2024, 'Amazon Gray', 60.00, 'hybrid', 'automatic', 5, 'compact', 'Modern compact SUV with hybrid efficiency.', 'BlueLink, Wireless Charging, Bose Audio, Smart Liftgate', '38 MPG', 'available')",
